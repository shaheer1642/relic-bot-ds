...
class DiscordAdminPanel extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    componentDidMount() {
        console.log('[DiscordAdminPanel] componentDidMount')
        this.props.login()
    ...
    componentWillUnmount() {
        console.log('[DiscordAdminPanel] componentWillUnmount')
    ...
    render() {
        return (
            !this.props.user ? <Typography variant='h4'>You are not logged in</Typography> :
                !this.props.user.is_staff ? <Typography variant='h4'>You are not logged in as staff</Typography> :
                    <Box sx={{ display: 'flex' }}>
...
export default withHooksHOC(DiscordAdminPanel)