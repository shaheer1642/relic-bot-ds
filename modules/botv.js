...
client.on('interactionCreate', (interaction) => {
    if (interaction.guild.id == botv_guild_id) {
        ...
        channel.messages.fetch(message_ids.challenges.challenges).then(message => {
            ...
            .then(res => {
                ...
                if (challenges.length > 0) {
                    ...
                    challenges.forEach(challenge => {
                        if (!challenge.guild_ids.includes(botv_guild_id)) return
                    ...
                    const payload = {
                        ...
                        embeds: [{
                            ...
                            fields: [{
                                ...
                                value: `RP: ${deals[0].rp}\n${transactions.filter(transaction => transaction.activation_id == deals[0].activation_id && transaction.guild_id == botv_guild_id).length} Purchased`
                            }],
                            color: '#2d7d46'
                        }],
                        components: [{
