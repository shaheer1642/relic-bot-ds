...
sleep 4000
updatePrices1(315, 241, 31)
RegWrite REG_DWORD, HKCU, Software\Softy Relic Bot, updatePriceThread3, 1
ExitApp

updatePrices1(starting1, starting2, starting3)
{
    ...
    ;prime items loop
    partsPricesArray := {}
    loop % itemsUrlArr.MaxIndex()  ;average plat value of all items in the array
    {
    ...
    ;creating new file
    file := FileOpen("pricesDBMT3.json", "w")
    if !IsObject(file)
    {
        MsgBox % "Can't open file for writing in script " A_ScriptName " at line " A_LineNumber
        return
    ...
    ;relics loop
    relicsPricesArray := {}
    loop % relicsUrlArr.MaxIndex() ;% itemsUrlArr.MaxIndex()   ;average plat value of all items in the array
    {
        ...
        */
        ...
        loop
        {
            ...
            if (A_index==500)
                msgbox stuck in a loop in thread 3
        }
    ...
    ;creating new file
    file := FileOpen("relicsDB3.json", "w")
    if !IsObject(file)
    {
        MsgBox % "Can't open file for writing in script " A_ScriptName " at line " A_LineNumber
        return
    ...
    ;mods loop
    modsPricesArray := {}
    loop % modsUrlArr.MaxIndex() ;% modsPricesArray.MaxIndex()   ;average plat value of all items in the array
    {
