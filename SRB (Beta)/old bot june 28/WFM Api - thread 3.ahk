...
updatePrices1(starting1, starting2)
{
    ...
    commaFlag := 0
    loop % itemsUrlArr.MaxIndex()-1   ;average plat value of all items in the array
    {
    ...
    loop % relicsUrlArr.MaxIndex()-1   ;average plat value of all items in the array
    {
